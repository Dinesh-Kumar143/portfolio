      ...
      <div className="max-w-[1200px] mx-auto px-13">
        <div className="grid grid-cols-2 gap-20 items-start max-md:grid-cols-1">
          ...
          <div>
            ...
            <FadeUp delay={0.1}>
              <h2 className="font-serif text-[clamp(34px,4vw,54px)] font-bold leading-[1.1] tracking-[-0.02em] text-[#0e0e0e] mb-4">
                Let&apos;s build
                <br />
                something great.
              </h2>
            ...
            <FadeUp delay={0.15}>
              <p className="text-[15px] text-[#3a3a3a] leading-[1.8] mb-8">
